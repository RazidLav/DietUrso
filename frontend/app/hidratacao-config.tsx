...
export default function HydrationConfigScreen() {
  ...
  return <View style={styles.screen} testID="hydration-config-screen">
    ...
    <ScrollView contentContainerStyle={{ padding: spacing.lg, paddingBottom: 100, gap: spacing.lg }}>
      ...
      <Section title="LEMBRETES INTERNOS" subtitle="Aparecem apenas dentro do UrsoFit. Não são notificações do sistema e respeitam o período silencioso.">
      ...
      <View style={styles.safety}><MaterialDesignIcons name="information-outline" size={20} color={colors.brandSecondary} /><Text style={styles.safetyText}>O UrsoFit acompanha a meta que você escolheu, sem sugerir diagnóstico ou substituir orientação profissional.</Text></View>
